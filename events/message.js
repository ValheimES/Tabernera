			...
			if (exists) {
				...
				if (MySql.update4('XP', `${msg.author.id}`, 'XP', `${String(parseInt(base.XP) + xp)}`)) {
					...
					if (parseInt(base2.XP) >= 23851 && parseInt(base2.XP) >= 67525 && !msg.member.roles.exists('id', '424585537035304962')) {
						...
						setTimeout(() => { msg.member.roles.add(msg.guild.roles.find('id', '424585482119413760')); }, 1000);
						...
						setTimeout(() => { msg.member.roles.remove(msg.guild.roles.find('id', '424585387596447765')); }, 1000);
						...
						setTimeout(() => { msg.member.roles.remove(msg.guild.roles.find('id', '424585289852256268')); }, 1000);
						...
						setTimeout(() => { msg.member.roles.remove(msg.guild.roles.find('id', '424585155408166922')); }, 1000);
						...
						setTimeout(() => { msg.member.roles.remove(msg.guild.roles.find('id', '424585008984883203')); }, 1000);
