			...
			if(exists) {
				...
				if(MySql.update4("XP", "" + msg.author.id, "XP", "" + String(parseInt(base.XP) + xp)))
				{
					const base2 = await MySql.get("XP", "ID", "" + msg.author.id);
						if(parseInt(base2.XP) >= 23850 && parseInt(base2.XP) >= 67525 && !msg.member.roles.exists('id', '424585537035304962'))
						{
							msg.member.addRole('424585537035304962'); // Rey pirata
							msg.member.removeRole('424585482119413760'); // Pirata experto
						...
						{
							msg.member.addRole('424585482119413760'); // Pirata experto
							msg.member.removeRole('424585387596447765'); // Pirata rufián
							canal.send(limpia + '5:** Pirata experto.');
						}
						else if(parseInt(base2.XP) >= 4675 && parseInt(base2.XP) >= 11825 && !msg.member.roles.exists('id', '424585387596447765'))
						{
							msg.member.addRole('424585387596447765'); // Pirata rufián
							msg.member.removeRole('424585289852256268'); // Grumete Gallina
							canal.send(limpia + '4:** Pirata rufián.');
						}
						else if(parseInt(base2.XP) >= 1150 && parseInt(base2.XP) >= 4675 && !msg.member.roles.exists('id', '424585289852256268'))
						{
							msg.member.addRole('424585289852256268'); // Grumete Gallina
							msg.member.removeRole('424585155408166922'); // Rata de Mar
						...
						{
							msg.member.addRole('424585155408166922'); // Rata de Mar
							msg.member.removeRole('424585008984883203'); // Limpiacubiertas
				...
				msg.member.addRole('424585008984883203'); // Limpiacubiertas
