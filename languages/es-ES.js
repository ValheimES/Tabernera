...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_HELP_NO_EXTENDED: 'No hay ejemplo de uso.',
			...
			COMMAND_ENABLE_DESCRIPTION: 'Rehabilita temporalmente un comando/inhibidor/monitor/finalizador. Estado por defecto al reiniciar.',
			COMMAND_DISABLE_DESCRIPTION: 'Redesahabilita o deshabilita temporalmente un comando/inhibidor/monitor/finalizador/evento. Estado por defecto al reiniciar.',
			COMMAND_CONF_GUARDED: (name) => `${util.toTitleCase(name)} no devería deshabilitarse.`,
			COMMAND_CONF_SERVER_DESCRIPTION: 'Define la configuracion del servidor.',
			COMMAND_CONF_SERVER: (key, list) => `**Configuracion del servidor${key}**\n${list}`,
			COMMAND_CONF_USER_DESCRIPTION: 'Define la configuracion del usuario.',
			COMMAND_CONF_USER: (key, list) => `**Configuración de usuario${key}**\n${list}`
		};
	}
